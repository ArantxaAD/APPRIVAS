...
public class PuntoDeInteresActivity extends AppCompatActivity { private boolean botonInformacion;
...
private static PuntoDeInteres puntoDeInteres;
  ...
  /*  private PuntoDeInteres getPuntoDeInteres(){
        return puntoDeInteres;
    }*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //IMAGEN DE PRUEBA
        /*ImageView imageView = findViewById(R.id.puntodeinteresfotos);
        Log.d("MIAPP","Dentro imagen");
        imageView.setImageResource(R.drawable.miralrio2);
        Log.d("MIAPP","fin imagen");*/

        //Objeto de prueba
        //FincaElPorcal objeto1 = new FincaElPorcal();
        //     puntoDeInteres = objeto1;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menupi, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id_item) {
            case R.id.boton_atras:
                Log.d("MYAPP", "Tocada opción salir");
                onBackPressed();

                break;

            default:
                Log.d("MYAPP", "Tocado opcion desconocida");
...
//        rellenarPuntuacion(punto_interes);
    ...
    public void rellenarPuntuacion(PuntoDeInteres punto_interes){
  /*      TextView text;
        String dato;

        text = findViewById(R.id.detalles_puntuacion);
        dato = punto_interes.getPuntuacion()+"";
        if(dato != null) {
            text.setText(dato);
        }else{
    ...
    public void rellenarTitulo(PuntoDeInteres punto_interes){
        TextView text;
/*
        text = findViewById(R.id.titulo_interes);
...
// FIN RELLENAR
   ...
   /*     TextView textView = findViewById(R.id.detalles_enlaceweb);
    ...
    public void mostrarPuntoInteres(PuntoDeInteres punto_interes){
        ...
        //  text = findViewById(R.id.detalles_puntuacion);
        //text.setText(punto_interes.getPuntuacion()+"");
...
*/
    ...
    //TODO MEJORA DE LAS ESTRELLAS DE RATING
    public void cambiarEstrellas(View view){
